...
const InvestigationTimeSlotMaster = () => {
  ...
  return (
    <>
      <PageHead name="Investigation Time Slot Master" showDrop={"true"}>
        <div className="card">
          <div className="row">
      ...
      {payloadDep?.DepartmentId !== "" && (
        <div className="card">
          <div className="row">
            <h3 className="card-header">{t("Department Schedule Details")}</h3>
          </div>
          <div className="card">
            <div className="row">
              <div className="col-md-2 control-label">
                ...
                />
                {payload?.ModalityId === "" && (
                  <span className="golbal-Error">{err?.ModalityId}</span>
                )}
              </div>

              <div className="col-md-4">
                <label
                  className="col-md-2 requiredlabel control-label"
                  htmlFor="Days"
                >
                  {t("Check Days")} :
                </label>
              ...
              <div className="col-md-1 control-label">
                <SelectBox
                  lable="Shift"
                  id="Shift"
                ...
                />
                {payload?.ShiftId === "" && (
                  <span className="golbal-Error">{err?.ShiftId}</span>
                )}
              </div>
              ...
              <div className="col-md-2 control-label">
                ...
                />
                {payload?.CentreId === "" && (
                  <span className="golbal-Error">{err?.CentreId}</span>
                )}
              </div>
            ...
            <div className="row control-label">
              <label

...
const MemberShipCardEdit = () => {
  ...
  return (
    <>
      ...
      <PageHead name="Membership Card Edit" showDrop="true">
        <div className="card">
          <div className="row">
      ...
      {loading ? (
        ...
        <>
              ...
              <div className="card">
                <div className="row">
                  <label className="col-sm-2">
                    Card Name: {cardDetails?.MembershipCardName}
                  </label>
                  <label className="col-sm-2">
                    Card Amount:{" "}
                  ...
                  <label className="col-sm-2">
                    No. of Dependents :{cardDetails?.MembershipCardDependent}
                  </label>
                  <label className="col-sm-2">
                    Expiry Date: {cardDetails?.ValidTo}
                  </label>
                </div>
              </div>
              <PageHead name="Member Details" showDrop="true">
                <div className="card">
                  <div className="row">
                    <Table>
                      <thead>
          ...
          {dependentData.length > 0 && (
            <PageHead name="Dependent Details" showDrop="true">
              <div className="card">
                <div className="row">
                  <Table>
                    <thead className="cf">
                        ...
                        dependentData.map((ele, ind) => (
                          <tr key={ind}>
                            ...
                            <td>
                              ...
                              >
                                <span className="col-sm-1">Y</span>
                                ...
                                <span className="col-sm-1">M</span>
                                <div className="col-sm-3">
                                  <Input
                                ...
                                <span className="col-sm-1">D</span>
                                <div className="col-sm-3">
                                  <Input
                                    className="form-control input-sm"
                                    name="AgeDays"

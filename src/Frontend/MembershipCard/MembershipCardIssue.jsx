...
import { AllowedSpecialChar } from "../util/Commonservices";
...
const MembershipCardIssue = () => {
  ...
  return (
    <>
      ...
      <PageHead name={t("Membership Card Issue")} showDrop="true">
        <div className="card">
          <div className="row">
      ...
      <PageHead name={t("Primary Member")} showDrop="true">
        <div className="card">
          <div className="row">
            <div className="col-sm-1">
              <Input
            ...
            <div className="col-sm-2 d-flex align-items-center">
              <div className="col-sm-3 d-flex align-items-center">
                <input
                  type="radio"
                  name="RadioDefaultSelect"
                  value={"Age"}
                  checked={
                    data?.PatientData?.RadioDefaultSelect === "Age"
                      ? true
                      : false
                  }
                  onChange={handleChange}
                />
                <label className="col-sm-10">{t("Age")}</label>
              </div>
            ...
            <div className="col-sm-2 d-flex align-items-center">
              <div className="col-sm-3 d-flex align-items-center">
                ...
                />
                <label className="col-sm-10">{t("DOB")}</label>
              </div>
      ...
      {data?.DependentData && data?.DependentData.length > 0 && (
        <PageHead name={t("Dependent Member")} showDrop="true">
          <div className="card">
            <Table>
              <thead className="cf text-center" style={{ zIndex: 99 }}>
                <tr>
                  ...
                  <th className="text-center requiredlabel">
                    {t("Patient Name")}
                  </th>
                  <th></th>
                  ...
                  <th className="text-center">{t("Relation  ")}</th>
                  <th className="text-center">{t("Photo")}</th>
                </tr>
              </thead>
              <tbody>
                {data?.DependentData &&
      ...
      <div className="card">
        <div className="row">
          ...
          <div className="col-sm-5">
            <div className="row">
              <label className="col-sm-3">Gross Amount:</label>
              <div className="col-sm-3">{Number(data?.cardAmt).toFixed(2)}</div>
              <label className="col-sm-3">Net Amount: </label>
              <div className="col-sm-3">{Number(data?.cardAmt).toFixed(2)}</div>
            </div>
            <div className="row">
              <label className="col-sm-3">Paid Amount: </label>
              <div className="col-sm-3">
                {Number(getAmount("paid")).toFixed(2)}
              </div>
              <label className="col-sm-3">Balance Amount: </label>
              <div className="col-sm-3">
                {Number(getAmount("balance")).toFixed(2)}
              </div>
            </div>

      ...
      >
        <div className="card">
            ...
            <div className="col-sm-2">
              <div className="input-group-append d-flex">
                <div className="col-sm-3">
                  <label className="col-sm-10">{t("Validity")}</label>
                </div>
                <div className="col-sm-3">
                  <Input
                    style={{ width: "10px" }}
          ...
          <div className="row">
            ...
            <label className="col-sm-1 d-flex align-items-cente">
              Status :
            </label>
            <div className="col-sm-1 d-flex align-items-center">
              ...
              <label className="col-sm-10">
                {payload?.IsActive ? "Active" : "De-Active"}
              </label>
            </div>
            {load.save ? (
              <Loading />
                ...
                <tbody>
                  {tableData?.map((ele, index) => (
                    <tr key={index}>
                      ...
                      <td data-title={t("Card Name")}>{ele?.CardName}&nbsp;</td>
                      ...
                      <td data-title={t("Card Amount")}>{ele?.Amount}&nbsp;</td>
                      <td data-title={t("Validity")}>{ele?.Validity}&nbsp;</td>

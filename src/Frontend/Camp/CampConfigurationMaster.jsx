...
const CampConfigurationMaster = () => {
  ...
  return (
    <>
      <PageHead name="Camp Configuration Count Master" showDrop={"true"}>
        {!access ? (
          ...
          <div className="row">
            ...
            <div className="col-sm-1">
              <div style={{ display: "flex" }}>
                ...
                ></div>
                <label style={{ marginLeft: "5px" }}>Approved</label>
              </div>
            </div>
                ...
                <Table>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        {tabledata.reduce((acc, ele) => acc + ele.Apr, 0)}
                      </td>
                      <td>
                        {tabledata.reduce((acc, ele) => acc + ele.May, 0)}
                      </td>
                      <td>
                        {tabledata.reduce((acc, ele) => acc + ele.Jun, 0)}
                      </td>
                      <td>
                        {tabledata.reduce((acc, ele) => acc + ele.Jul, 0)}
                      </td>
                      <td>
                        {tabledata.reduce((acc, ele) => acc + ele.Aug, 0)}
                      </td>
                      <td>
                        {tabledata.reduce((acc, ele) => acc + ele.Sep, 0)}
                      </td>
                      <td>
                        {tabledata.reduce((acc, ele) => acc + ele.OCT, 0)}
                      </td>
                      <td>
                        {tabledata.reduce((acc, ele) => acc + ele.Nov, 0)}
                      </td>
                      <td>
                        {tabledata.reduce((acc, ele) => acc + ele.Dec, 0)}
                      </td>
                      <td>
                        {tabledata.reduce((acc, ele) => acc + ele.Jan, 0)}
                      </td>
                      <td>
                        {tabledata.reduce((acc, ele) => acc + ele.Feb, 0)}
                      </td>
                      <td>
                        {tabledata.reduce((acc, ele) => acc + ele.Mar, 0)}
                      </td>
                      <td>
                        {tabledata.reduce((acc, ele) => acc + ele.Total, 0)}
                      </td>
                    </tr>
                  </tbody>
                </Table>

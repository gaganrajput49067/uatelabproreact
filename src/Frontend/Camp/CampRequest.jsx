...
const CampRequest = () => {
  ...
  const handleChange = (event) => {
    ...
    if (
      ...
      toast.error("Please select Center and CampType");
    } else {
      debouce(value);
      setFormData((ele) => ({
        ...ele,
  ...
  return (
    <>
      ...
      <PageHead name="Camp Request" showDrop={"true"}>
        <div className="card">
          <div className="row">
...
const CampRejectModal = ({ show, onHide, handleReject }) => {
  ...
  return (
    <Modal title="Reject Reason" handleClose={onHide}>
      <div className="card">
        <div className="row">

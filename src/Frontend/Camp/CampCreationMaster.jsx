...
const CampCreationMaster = () => {
    ...
    switch (name) {
      case "TestName":
        ...
        const obj = {
          ...
          AddedBy: getLocalStorageDecryptData("Username"),
  ...
  return (
    <>
      <PageHead name="Camp Creation Master" showDrop={"true"}>
        <div className="card">
      ...
      {selected === "ccm" && (
        <PageHead name="Camp Name Creation Master" showDrop={"true"}>
          <div className="card">
            <div className="row">
      ...
      {selected === "fcm" && (
        <PageHead name="Free Camp Test Master" showDrop={"true"}>
          <div className="card">
            <div className="row">

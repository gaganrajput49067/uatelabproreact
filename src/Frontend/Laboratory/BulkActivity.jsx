...
const BulkActivity = () => {
  ...
  return (
    <>
      <PageHead name="BulkApprovalScreen" showDrop={"true"}>
        <div className="card">
          <div className="row">
          ...
          <div className="row">
            ...
            <div className="col-sm-1">
              <input
                ...
                onChange={handleChange}
              />
              <label className="ml-2">IsCulture</label>
            </div>
                        ...
                        <>
                          <tr key={index}>
                            ...
                            <td colSpan={8}>
                              ...
                              {ele?.PatientName}, Age/Gender:{ele?.AgeGender},
                              SINNo:
                              {ele?.BarcodeNo}, RegistrationDate:
                              {ele?.orderDAte}, IPNo:
                              {ele?.IPNo ?? "-"}, Source:{ele?.Source ?? "-"},
                              RefBy:{ele?.RefBy}
                            </td>
                          </tr>
                          <tr
                          ...
                          >
                              ...
                              {downloadLoading?.[ele?.TestIDHash]
                                ...
                                >
                                  ...
                                  >
                                    ...
                                    {downloadLoading?.[ele?.TestIDHash]?.icons}
                                  </strong>
                                </div>
                              )}
                            </td>
                            ...
                            {[6, 5].includes(ele?.Status) ? (
                              <td data-title={t("Print")}>
                                {actionLoading?.load &&
                                actionLoading?.type === "Printwithoutheader" &&
                                actionLoading?.index === index ? (
                                  <Loading />
                                ) : (
                                  <i
                    ...
                    [5, 6].includes(parseInt(payload?.SampleStatus)) && (
                      <div className="col-sm-2">
                        <button
                          ...
                          onClick={() => setBulkDownloadtypeState(true)}
                        >
                          Bulk Download
                        </button>
                      </div>

...
const BlockComponent = () => {
  const data = [
    ...
    { title: 'Percentage', value: '10.50%', backgroundColor: 'rgb(235 128 58)' },
    { title: 'Orders', value: '489', backgroundColor: 'rgb(239 39 27)' },
    { title: 'Top Customer', value: 'Isaac Dan', backgroundColor: 'rgb(251 181 28)' },
  ...
  const containerStyle = {
    ...
    justifyContent: 'space-around', // Equal spacing around blocks, including at the ends
  };
  ...
  return (
    <div style={containerStyle} className="container">
      {data.map((item, index) => (
        ...
        >
          <span style={{ fontSize: '24px', fontWeight: 'bold' }}>{item.value}</span><br />

...
const ManageDeliveryDays = () => {
  ...
  const handleSubmit = () => {
    ...
    const payload = data.map((item) => ({
      ...
      ExcludeHoliday: item?.ExcludeHoliday,
    }));
  ...
  return (
    <>
      <PageHead name={t("Manage Delivery Days")} showDrop="true">
        <div className="card">
          <div className="row">
                ...
                <tbody>
                  {tableData.map((data, index) => (
                    ...
                    >
                      ...
                      <td className="text-center" data-title={t("Department")}>
                        {data?.DeptName}&nbsp;
                      </td>
                      {state?.type != 2 && (
                        <td className="text-center" data-title={t("Item Name")}>
                          {data?.InvName}&nbsp;
                        </td>
                      )}
                      ...
                      <td className="text-center" data-title={t("CutOffTime")}>
                        <Input
                          type="time"

...
const OutSourceTestToOtherLab = () => {
      ...
      .then((res) => {
        ...
        const val = data?.map((ele) => {
          return {
            ...
            OutSourceTestCode: handleDropdown(ele?.OutsourceName)[0]?.code,
            OutSourceRate: handleDropdown(ele?.OutsourceName)[0]?.rate,
          };
        });
        setTableData(val);
        setLoading(false);
  ...
  return (
    <>
      ...
      <PageHead name="Outsource Test To Other Lab" showDrop={"true"}>
        <div className="card">
          <div className="row">
                ...
                {tableData?.map((ele, index) => (
                  ...
                  >
                    ...
                    <td data-title={t("Add Report")}>
                      {ele?.STATUS == "OutSourced" && ele?.Approved == 0 && (
                        <button

...
import { autocompleteOnBlur, getTrimmedData, PreventSpecialCharacter } from "../../utils/helpers";
import {
...
import { DataType, ReportTypeNew, SampleOption } from "../../utils/Constants";
  ...
  return (
    <>
      ...
      {editLoading ? (
        ...
        <PageHead name="Investigations" showDrop={"true"}>
          <>
            <div className="card">
              <div className="row">
              ...
              <div className="row">
                <div className="col-sm-2 ">
                  <SelectBox
                    ...
                    name="DataType"
                    isDisabled={
                      (state?.url1 && saved) || dataForUpdate?.url1
                        ? true
                        : false
                    }
                  />
                  ...
                  <>
                    <div className="col-sm-2">
                      <Input
                        ...
                        onBlur={handleBlur}
                        disabled={
                          formData?.DataType == "Package" ? true : false
                        }
                        required
                      />
                  ...
                  <div className="row">
                    <div className="col-sm-5">
                      <ReactSelect
                        ...
                        onChange={(_, e) =>
                          handleProfileChange(e.value, e.label)
                        }
                      />
                    </div>
                  </div>

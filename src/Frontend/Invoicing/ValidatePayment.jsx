...
const ValidatePayment = () => {
  ...
  return (
    <>
      ...
      <PageHead name="Pending Amount Validation" showDrop={"true"}>
        <div className="card">
          <div className="row">
          ...
          <tbody>
            {tableData?.map((ele, index) => (
              <tr key={index}>
                ...
                <td data-title={t("Paid Amount")}>{ele?.ReceivedAmt} &nbsp;</td>

                <td data-title={t("Bank Name")}>{ele?.BankName} &nbsp;</td>
                <td data-title={t("Cheque No.")}>{ele?.CardNo} &nbsp;</td>
                <td data-title={t("Cheque Date")}>{ele?.CardDate} &nbsp;</td>
